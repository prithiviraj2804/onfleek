    ...
    <htmlpageheader name="myHTMLHeader">
        <table width="100%">
            <tr width="100%" align="center">
                <td width="100%" colspan="2" style="text-transform: uppercase;width:100%;text-align: center;font-size:24px;float:left;">Tax Invoice</td>
            </tr>
            <tr width="100%">
    ...
    <main style="padding:12px;">
        ...
        <table width="100%" class="item-tables">
            <tr width="100%">
                <td width="45%" style="width:45%;float: left;">
                    ...
                    <?php } if($customer_details->client_name){ ?>
                        <tr width="100%">    
                            ...
                            <td class="car_reg_no" width="65%"><?php echo $customer_details->client_name;?></td>
                        </tr>
                ...
                <td width="54%" style="float: right; text-align: right;">
                       ...
                       <?php if($invoice_detail->invoice_no){ ?>
                        ...
                        <?php } if($invoice_detail->model_name){ ?>
                            <tr width="100%" style="width:100%;">
                                ...
                                <td>
                                    <?php echo ($invoice_detail->car_model_year?$invoice_detail->car_model_year."-":" ")."".($invoice_detail->model_name?$invoice_detail->model_name:"")."".($invoice_detail->variant_name?"-".$invoice_detail->variant_name:" "); ?>
                                </td>
                            </tr>
                        <?php } if($invoice_detail->fuel_type){ ?>
                            <tr width="100%" style="width:100%;">
                                <td><?php _trans('lable132'); ?> :</td>
                                <td>
                                    <?php if($invoice_detail->fuel_type == 'P'){ echo "Petrol"; } else if($invoice_detail->fuel_type == 'D'){ echo "Diesel"; } ?>
                                </td>
                            <tr>
                        <?php } if($invoice_detail->current_odometer_reading){ ?>
                            <tr width="100%" style="width:100%;">
                                <td><?php _trans('lable1053'); ?>:</td>
                                <td>
                        ...
                        <?php } if($invoice_detail->fuel_level){ ?>
                            <tr width="100%" style="width:100%;">
                                <td><?php _trans('lable284'); ?> :</td>
                                <td>
                                    <?php echo $invoice_detail->fuel_level;?>
                                </td>
                            </tr>
                        <?php } ?>
                    </table>
        ...
        <div>
            <h4 style="padding:0px 0px 10px 0px; margin: 0;font-size:12px;font-weight: bold;"><?php _trans('lable1022'); ?></h4>
        </div>
        <table class="item-table">
            <thead>
                <tr>
