    ...
    <htmlpageheader name="myHTMLHeader">
        <table width="100%">
            <tr width="100%" align="center">
                <td width="100%" colspan="2" style="text-transform: uppercase;width:100%;text-align: center;font-size:24px;float:left;"><?php _trans('lable1054'); ?></td>
            </tr>
            <tr width="100%">
                       ...
                       <?php if($invoice_detail->invoice_no){ ?>
                        ...
                        <?php } if($invoice_detail->invoice_date){ ?>                    
                            <tr width="100%" style="width:100%;">
                                ...
                                <td><?php echo $invoice_detail->invoice_date; ?></td>
                            </tr>
