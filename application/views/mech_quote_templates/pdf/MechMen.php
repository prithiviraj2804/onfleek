...
<body>
    <header>
        <table width="100%">
            <tr width="100%" align="center" >
                <td width="100%" colspan="2" style="text-transform: uppercase;text-align: center;font-size:24px;"><?php _trans('lable837'); ?></td>
            </tr>
            <tr width="100%">
    ...
    <main>
                       ...
                       <?php if($quote_detail->quote_no){ ?>
                        ...
                        <?php } if($quote_detail->current_odometer_reading){ ?>
                            <tr width="100%" style="width:100%;">
                                ...
                                <td>
                                    <?php echo ($quote_detail->current_odometer_reading?$quote_detail->current_odometer_reading:" "); ?>
                                </td>
                            </tr>
                        <?php } ?>
                    </table>
        ...
        <div>
            <h4 style="font-size:12px;font-weight: bold;"><?php _trans('lable344'); ?></h4>
        </div>
        ...
        <div>
            <h4 style="font-size:12px;font-weight: bold;">Labour</h4>
        </div>
        <table class="item-table">
            <thead>
                <tr>
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="item-amount text-right"><?php echo $this->mdl_settings->currencychanger($this->session->userdata('default_currency_code')).';'; ?>&nbsp;<?php echo format_money(($quote_detail->service_grand_total?$quote_detail->service_grand_total:0),$this->session->userdata('default_currency_digit')); ?></td>
                </tr>
            </tfoot>
        </table>
        <?php } ?>
        ...
        <div>
            <h4 style="font-size:12px;font-weight: bold;"><?php _trans('lable546'); ?></h4>
        </div>
        <table class="item-table">
            <thead>
                <tr>
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="item-amount text-right"><?php echo $this->mdl_settings->currencychanger($this->session->userdata('default_currency_code')).';'; ?>&nbsp;<?php echo format_money(($quote_detail->service_package_grand_total?$quote_detail->service_package_grand_total:0),$this->session->userdata('default_currency_digit')); ?></td>
                </tr>
            </tfoot>
        </table>
        <?php } ?>
        ...
        <div style="width:100%;float:left;">
            ...
            <div style="width:65%;float:right;font-size:14px;">
                <table class="item-table">
                    <?php if (count(json_decode($product_list)) > 0) { ?>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="item-amount text-left" style="border:none;"><?php echo $this->mdl_settings->currencychanger($this->session->userdata('default_currency_code')).';'; ?>&nbsp;<?php echo format_money($quote_detail->service_grand_total,$this->session->userdata('default_currency_digit')); ?></td>
                    </tr>
                    <?php } ?>
                    ...
                    <tr>
                        ...
                        <td class="item-amount text-left" style="border:none;"><?php echo $this->mdl_settings->currencychanger($this->session->userdata('default_currency_code')).';'; ?>&nbsp;<?php echo format_money($quote_detail->service_package_grand_total,$this->session->userdata('default_currency_digit')); ?></td>
                    </tr>
                    <?php } ?>
                    <tr>
...
<div class="footer_bg"><?php _trans('lable1045'); ?></div>
    <div class="welcome" style="width:100%;float:left;">
        <table class="table table-bordered center">
           <tr width="100%" align="center" >
                <td width="100%"  style="text-transform: uppercase;text-align: center;">
		 <?php _trans('lable1114'); ?>
		</td>
            </tr>
        </table>
        </div>
</footer>
<?php /*  <htmlpagefooter name="myHTMLFooter">
    <div class="footer_bg"><?php _trans('lable1045'); ?></div>
    <div class="welcome" style="width:100%;float:left;">
        <table class="table table-bordered center">
            <tr>
