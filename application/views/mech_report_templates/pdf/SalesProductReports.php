        ...
        <table class="customer-details" style="font-size:.9375rem;margin-bottom: 0;background: #fff;table-layout:fixed;border: 1px solid #eceeef;width: 100%;max-width: 100%;border-collapse: collapse;border-spacing: 0;" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th class="text_align_center"><?php _trans('lable207'); ?></th>
                    <th class="text_align_center"><?php _trans('lable208'); ?></th>
                    <th class="text_align_center"><?php _trans('lable643'); ?></th>
                    <th class="text_align_center"><?php _trans('lable642'); ?></th>
                    <th class="text_align_center"><?php _trans('lable641'); ?></th>
                    <th class="text_align_center"><?php _trans('lable331'); ?></th>
            ...
            <tbody>
                <?php if(count($results) > 0){
                    ...
                    <tr>
                        ...
                        <td class="text_align_center"><?php echo $result->product_name; ?></td>
                        <td class="text_align_center"><?php echo $result->family_name; ?></td>
                        <td class="text_align_center"><?php echo $result->qty; ?></td>
                        <td class="text_align_center"><?php echo $result->cost_price; ?></td>
                        <td class="text_align_center"><?php echo $result->sale_price; ?></td>
                        <td class="text_align_center"><?php echo $result->tax_percentage; ?></td>
                        <td class="text_align_center"><?php echo $result->amt; ?></td>
                    </tr>
                <?php } ?>
                    <tr>
                        <td colspan="7" class="text_align_center"><?php _trans('lable625'); ?></td>
                        <td class="text_align_center"><?php echo $overall_grand_total; ?></td>
                    </tr>
                <?php }else{ ?>
                <tr>
                    <td colspan="8" align="center"><?php _trans('lable1046'); ?></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
