            ...
            <tbody>
                <?php if(count($results) > 0){
                    ...
                    <tr>
                        ...
                        <td class="text_align_center"><?php echo number_format($result->total, 2); ?></td>
                    </tr>
                <?php } ?>
                    <tr>
                        <td colspan="2" class="text_align_center"><strong><?php _trans('lable625'); ?></strong></td>
                        <td class="text_align_center"><strong><?php echo number_format($overall_grand_total, 2); ?></strong></td>
                    <tr>
                <?php }else{ ?>
                <tr>
