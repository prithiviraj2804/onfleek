        ...
        <table class="customer-details" style="font-size:.9375rem;margin-bottom: 0;background: #fff;table-layout:fixed;border: 1px solid #eceeef;width: 100%;max-width: 100%;border-collapse: collapse;border-spacing: 0;" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th class="text_align_center"><?php _trans('lable626'); ?></th>
                    <th class="text_align_center"><?php _trans('lable627'); ?></th>
                </tr>
            </thead>
            <tbody>
                ...
                foreach ($results as $result){ 
                    ...
                    <tr>
                        ...
                        <td class="text_align_center"><?php echo $result->total_paid_amount; ?></td>
                        <td class="text_align_center"><?php echo $result->total_due_amount; ?></td>
                    </tr>
                <?php } ?>
                    <tr>
                        ...
                        <td class="text_align_center"><strong><?php echo $overall_total_paid_amount; ?></strong></td>
                        <td class="text_align_center"><strong><?php echo $overall_total_due_amount; ?></strong></td>
                    <tr>
           <?php }else{ ?>
                <tr>
                    <td colspan="5" align="center"><?php _trans('lable1046'); ?></td>
                </tr>
                <?php } ?>
            </tbody>
        </table>
