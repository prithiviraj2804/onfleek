...
<body>
    ...
    <main style="padding:20px;">
        ...
        <div style="width:100%;float:left;padding:5px;">
            <h5 style="padding:0px; margin: 0;font-size:14px;"><?php _trans('lable1001'); ?></h5>
        </div>
        ...
        <div id="content" class="table-content">
            ...
            <tr width="100%">
                <td width="45%" style="width:45%;float: left;">
                    <table width="100%">
                            <tr width="100%">
                                <td width="45%"><?php _trans('lable80');?> :</td>
                                <?php foreach ($supplier_info as $supplier_in){  ?>
                                <td width="100%"><?php echo $supplier_in->supplier_name; ?></td>
                                <?php } ?>
                            </tr>

                            <tr width="100%">
                                <td width="45%"><?php _trans('lable1000');?> :</td>
                                <?php foreach ($supplier_info as $supplier_in){  ?>
                                <td width="100%"><?php echo ($supplier_in->supplier_street?$supplier_in->supplier_street:"")." ".($supplier_in->city_name?",".$supplier_in->city_name:"")." ".($supplier_in->state_name?",".$supplier_in->state_name:"")." ".($supplier_in->country_name?",".$supplier_in->country_name:"")." ".($supplier_in->supplier_pincode?",".$supplier_in->supplier_pincode:""); ?></td>
                                <?php } ?>
                            </tr>
                            
                            <tr width="100%">
                                <td width="43%"><?php _trans('label946');?> :</td>
                                <?php foreach ($supplier_info as $supplier_in){  ?>
                                <td width="100%"><?php echo $supplier_in->supplier_contact_no; ?></td>
                                <?php } ?>
                            </tr>
                    </table>
                </td>
