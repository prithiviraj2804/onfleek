...
|
*/
$config['base_url'] = 'https://appin.mechtoolz.com';
...
$config['sess_save_path'] = 'ip_sessions';
//sys_get_temp_dir();
...
$config['csrf_token_name'] = '_mm_csrf';
$config['csrf_cookie_name'] = 'mm_csrf_cookie';
$config['csrf_expire'] = 7200;
$config['csrf_regenerate'] = FALSE;
$config['csrf_exclude_uris'] = array('api/send_otp', 'api/signup','api/login','api/cars/create','api/cars/update/[0-9]+','api/cars/list/[0-9]+','api/cars/list','api/cars/remove/[0-9]+','api/myaddress/list','api/myaddress/create','api/myaddress/update/[0-9]+','api/myaddress/remove/[0-9]+','api/area/list','api/verify_otp','api/cars/basic','api/appointment/book','api/quotes/basic','api/quotes/create',
	'api/quotes/update','api/quotes/list','api/quotes/track','api/update_user_detail','api/quotes/updatepickup','api/quotes/updatedelivery','api/quotes/updatepayment','api/appointment/active','api/appointment/branch_list/[0-9]+','api/appointment/list', 'api/appointment/view', 'api/servicepackage/offers/[0-9]','api/servicecategory/list/[0-9]', 'api/servicepackagedtl/view/[0-9]+/[0-9]+',
	'api/crone/sendmail','api/crone/sendfirebasemail');
