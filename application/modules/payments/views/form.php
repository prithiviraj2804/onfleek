    ...
    <div id="content">
        ...
        <div class="form-group">
            <div class="col-xs-12 col-sm-2 text-right text-left-xs">
                <label for="invoice_id" class="control-label"><?php _trans('lable119'); ?></label>
            </div>
        ...
        <div class="form-group has-feedback">
            <div class="col-xs-12 col-sm-2 text-right text-left-xs">
                <label for="payment_date" class="control-label"><?php _trans('lable116'); ?></label>
            </div>
            <div class="col-xs-12 col-sm-6">
        ...
        <div class="form-group">
            <div class="col-xs-12 col-sm-2 text-right text-left-xs">
                <label for="payment_amount" class="control-label"><?php _trans('lable115'); ?></label>
            </div>
            <div class="col-xs-12 col-sm-6">
        ...
        <div class="form-group">
            <div class="col-xs-12 col-sm-2 text-right text-left-xs">
                <label for="payment_note" class="control-label"><?php _trans('lable118'); ?></label>
            </div>
            <div class="col-xs-12 col-sm-6">
