...
<table class="item_table">
    ...
    <tbody>
        ...
        foreach ($service_list as $service){ 
            ...
            $total_item_discount_price_service += $service->item_discount;
        ...
        <tr>
            ...
            <td width="10%" style="width:10%;" class="item-desc text-right"><?php echo $this->mdl_settings->currencychanger($this->session->userdata('default_currency_code')); ?>&nbsp;<?php echo format_money($service->item_discount,$this->session->userdata('default_currency_digit')); ?></td>
    ...
    <tfoot>
        <tr>
            ...
            <td class="item-amount text-right"><?php echo $this->mdl_settings->currencychanger($this->session->userdata('default_currency_code')).';'; ?>&nbsp;<?php echo format_money(($mech_leads->service_grand_total?$mech_leads->service_grand_total:0),$this->session->userdata('default_currency_digit')); ?></td>
        </tr>
    </tfoot>
</table>
<?php } ?>