...
<table class="item_table">
	<thead>
		<tr>
			...
			<th width="10%;" style="width:20%;" class="text-left"><?php _trans('label942'); ?></th>
	...
	<tbody>
		...
		<tr>
			...
			<td width="10%;" style="width:20%;" class="text_align_left"><?php echo $service->employee_name; ?></td>
	...
	<tfoot>
		<tr>
			<td colspan="4" class="item-desc text-right"><b>Total</b></td>
			<td class="item-amount text-right"><?php echo $this->mdl_settings->currencychanger($this->session->userdata('default_currency_code')); ?>&nbsp;<?php echo format_money(($mech_leads->service_package_grand_total?$mech_leads->service_package_grand_total:0),$this->session->userdata('default_currency_digit')); ?></td>
		</tr>
	</tfoot>
</table>
<?php } ?>