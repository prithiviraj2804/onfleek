        ...
        <table class="item_table">
            ...
            <tbody>
				...
				foreach (json_decode($product_list) as $product) {
                    ...
                    $total_item_discount_price_spare += $product->item_discount;
                ...
                <tr>
                    ...
                    <td width="13%" style="width:13%;" class="item-desc text-right"><?php echo $this->mdl_settings->currencychanger($this->session->userdata('default_currency_code')); ?>&nbsp;<?php echo format_money($product->item_discount,$this->session->userdata('default_currency_digit')); ?></td>
            ...
            <tfoot>
                <tr>
					...
					<td class="item-amount text-right"><?php echo $this->mdl_settings->currencychanger($this->session->userdata('default_currency_code')).';'; ?>&nbsp;<?php echo format_money(($mech_leads->product_grand_total?$mech_leads->product_grand_total:o),$this->session->userdata('default_currency_digit')); ?></td>
                </tr>
            </tfoot>
        </table>
        <?php } ?>