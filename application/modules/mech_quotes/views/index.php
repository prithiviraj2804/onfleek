...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-center imageDynamicHeight" style="display: table;">
    <div class="tbl-cell">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-center">
            <a class="btn btn-sm btn-primary" href="<?php echo site_url('mech_quotes/create'); ?>">
...
<div class="container-fluid">
	<?php 
        $this->layout->load_view('mech_quotes/partial_admin_appointment_table');
    ?>
</div>
<?php } ?>
