        ...
        <div class="tbl">
            <div class="tbl-row">
                <div class="tbl-cell" id="total_user_quote">
                    <h3><?php _trans('lable511');?> <?php if($mech_leads->leads_no) { echo " - ".$mech_leads->leads_no; } ?></h3>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
	<div class="col-xs-12 top-15">
        <a class="anchor anchor-back" href="<?php echo site_url('mech_leads/index'); ?>"><i class="fa fa-long-arrow-left"></i><span><?php _trans('lable59');?></span></a>
	</div>
</div>
<div class="container-fluid viewPages">
	<div class="paddingTop22px">
		<section class="card col-lg-10 col-md-10 col-sm-12 col-xs-12 col-centered">
    		...
    		<div class="card-block invoice">
    			<?php $this->layout->load_view('mech_leads/partial_product_table_view'); ?>
           	</div>
			<?php } ?>
			<?php if(count(json_decode($service_list)) > 0){ ?>
    		<div class="card-block invoice">
    			<?php $this->layout->load_view('mech_leads/partial_service_table_view'); ?>
           	</div>
			<?php } ?>
			<?php if(count(json_decode($service_package_list)) > 0){ ?>
    		<div class="card-block invoice">
    			<?php $this->layout->load_view('mech_leads/partial_service_package_table_view'); ?>
           	</div>
			<?php } ?>
    		...
    		<div class="card-block invoice">
    			<div class="row invoiceFloatbtn">
                    <div class="col-lg-12 clearfix buttons text-right">
						<a class="btn btn-rounded btn-primary btn-padding-left-right-40" href="<?php echo site_url('mech_leads/form/'.$mech_leads->ml_id); ?>">
