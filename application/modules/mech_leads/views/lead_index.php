        ...
        <section class="card">
            <div class="card-block">
                <div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 padding0px">
                    ...
                    <div class="form_group col-xl-4 col-lg-4 col-md-4 col-sm-4">
                        <label class="form_label"><?php _trans('lable499'); ?></label>
                        <div class="form_controls">
                    ...
                    <div class="form_group col-xl-4 col-lg-4 col-md-4 col-sm-4">
                        <label class="form_label"><?php _trans('lable509'); ?></label>
                        <div class="form_controls">
                            <select onchange="searchFilter()" name="lead_status" id="lead_status" class="searchSelect bootstrap-select bootstrap-select-arrow form-control removeError" data-live-search="true">
                                ...
                                <option value="<?php echo $mechLeadStatus->mlstatus_id; ?>"> <?php echo $mechLeadStatus->status_label; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                ...
                <div id="posts_content">
                    <div class="overflowScrollForTable">
                        <table class="display table datatable table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th><?php _trans('lable487');?></th>
                                    <th><?php _trans('lable488'); ?></th>
                                    <th><?php _trans('lable36'); ?></th>
                                    <th><?php _trans('lable672'); ?></th>
                                    <th><?php _trans('lable38'); ?></th>
                                    <th><?php _trans('lable499');?></th>
                                    <th><?php _trans('lable509');?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="textEllipsis"><a data-original-title="<?php _htmlsc($leads_ind->leads_no); ?>" data-toggle="tooltip" href="<?php echo site_url('mech_leads/view/' . $leads_ind->ml_id ); ?>"><?php _htmlsc($leads_ind->leads_no); ?></a></td>
                                    ...
                                    <td class="text_align_center">
                                        <div class="options btn-group <?php echo $dropup; ?>">
                                            ...
                                            <ul class="optionTag dropdown-menu">
                                                <li>
                                                    <a href="<?php echo site_url('mech_leads/form/' . $leads_ind->ml_id); ?>">
                                                        <i class="fa fa-edit fa-margin"></i> <?php _trans('lable44'); ?>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo site_url('mech_leads/convert_to_appointment/' . $leads_ind->ml_id); ?>">
                                                        <i class="fa fa-edit fa-margin"></i> <?php _trans('lable489'); ?>
                                                    </a>
                                                </li>
                                                <?php if($this->session->userdata('workshop_is_enabled_jobsheet') == 'Y'){
                                                        ...
                                                        <li>
                                                            <a href="<?php echo site_url('mech_leads/convert_to_jobcard/' . $leads_ind->ml_id); ?>">
												...
												<?php }}} foreach($permission as $perlist){
                                                        ...
                                                        <li>        
                                                            <a href="<?php echo site_url('mech_leads/convert_to_invoice/' . $leads_ind->ml_id); ?>">
                                                            <i class="fa fa-edit fa-margin"></i> <?php _trans('lable490'); ?>
                                                            </a>
                                                        </li>    
												<?php }} ?>
                                                <li>
                                                    <a href="javascript:void(0)" onclick="delete_record('mech_leads',<?php echo $leads_ind->ml_id; ?>, '<?= $this->security->get_csrf_hash() ?>')"> <i class="fa fa-trash-o fa-margin"></i> <?php _trans('lable47'); ?></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
...
function searchFilter(page_num) {
    ...
    $.post('<?php echo site_url('mech_leads/ajax/get_filter_list'); ?>', {
        page : page_num,
        from_date : from_date,
        to_date   : to_date,
        leads_no : leads_no,
        ...
        if(list.success=='1'){
            ...
            html += '<thead><tr>';
            html += '<th><?php _trans('lable487'); ?></th>';
            html += '<th><?php _trans('lable488'); ?></th>';
            html += '<th><?php _trans("lable36"); ?></th>';
            html += '<th><?php _trans("lable672");?></th>';
            html += '<th><?php _trans("lable38"); ?></th>';
            html += '<th><?php _trans("lable499"); ?></th>';
            html += '<th><?php _trans("lable509"); ?></th>';
            ...
            if(list.mech_lead_status.length > 0){
                ...
                if(list.mech_lead_status.length >= 4)
                {
                    ...
                    html += '<td class="textEllipsis"><a data-original-title="'+((list.mech_lead_status[v].leads_no)?list.mech_lead_status[v].leads_no:" ")+'" data-toggle="tooltip"  href="<?php echo site_url("mech_leads/view/'+list.mech_lead_status[v].ml_id+'"); ?>">'+((list.mech_lead_status[v].leads_no)?list.mech_lead_status[v].leads_no:" ")+'</a></td>';
                    ...
                    html += '<li><a href="<?php echo site_url("mech_leads/form/'+list.mech_lead_status[v].ml_id+'"); ?>">';
                    html += '<i class="fa fa-edit fa-margin"></i> <?php _trans("lable44"); ?></a></li>';
                    html += '<li><a href="<?php echo site_url("mech_leads/convert_to_appointment/'+list.mech_lead_status[v].ml_id+'"); ?>">';
                    html += '<i class="fa fa-edit fa-margin"></i> <?php _trans("lable489"); ?></a></li>';
                    ...
                    if(workshop_is_enabled_jobsheet == 'Y'){
                        ...
                        for(var n = 0; n < list.permission.length; n++){
                            if(list.permission[n].module_name == "jobs"){
                                html += '<li><a href="<?php echo site_url("mech_leads/convert_to_jobcard/'+list.mech_lead_status[v].ml_id+'"); ?>">';
                        ...
                        for(var k = 0; k < list.permission.length; k++){
                            if(list.permission[k].module_name == "invoice"){
                                html += '<li><a href="<?php echo site_url("mech_leads/convert_to_invoice/'+list.mech_lead_status[v].ml_id+'"); ?>">';
                                html += '<i class="fa fa-edit fa-margin"></i> <?php _trans("lable490"); ?></a></li>';
                            }
                        }

                    html += '<li><a href="javascript:void(0)" onclick="delete_record(\'mech_leads\',\''+list.mech_lead_status[v].ml_id+'\',\'<?= $this->security->get_csrf_hash() ?>\')">';
