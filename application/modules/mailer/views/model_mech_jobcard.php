...
<script type="text/javascript">
    ...
    $(function () {
	    ...
	    $('#btn_generate_pdf').click(function () {
            window.open('<?php echo site_url('mech_work_order_dtls/generate_pdf/'.($jobcard_id)); ?>', '_blank');
        });
...
<div class="modal fade" id="send-invoice" tabindex="-1" role="dialog" aria-labelledby="addNewCustomerLabel">
	<div class="modal-dialog" role="document">
		...
		<div class="modal-content withfull" id="add_customer_fdetail">
				<form class="withfull" method="post" class="form-horizontal" action="<?php echo site_url('mailer/send_mech_jobcard/'.($jobcard_id)); ?>">
				...
				<div class="modal-body withfull">
					<div class="withfull">
						<div class="withfull text-center">
							<div class="col-xs-12">
								<h3 class="modal__h3"><?php echo _trans('lable1119'); ?></h3>
							</div>
						</div>
						<div class="withfull">
							<div class="form_group">
								<label class="form_label"><?php _trans('lable836'); ?></label>
							...
							<div class="form_group">
								<label class="form_label"><?php _trans('lable1124'); ?></label>
								<div class="form_controls">
									<input type="text" name="to_email" id="to_email" class="form-control" value="<?php echo $job_card->client_email_id; ?>" required="required" autocomplete="off">
			               			<input type="hidden" name="from_name" id="from_name" value="<?php echo $users->user_company; ?>"autocomplete="off">
			               			<input type="hidden" name="jobcard_id" id="jobcard_id" value="<?php echo $jobcard_id; ?>"autocomplete="off">
							...
							<div class="form_group">
								...
								<div class="form_controls">
										<a class="layout_text_color" href="javascript:void(0)" id="btn_generate_pdf" style="font-size: 16px;" data-invoice-id="<?php echo ($job_card->work_order_id); ?>">
		                      				<i class="fa fa-eye" aria-hidden="true" style="font-size: 20px;"></i>     <?php _trans('lable1123'); ?></a>
                       			</div>
							</div>
							...
							<div class="form_group">
								<label class="form_label"></label>
								<div class="form_controls">
										<a href="javascript:void(0)" onclick="show_option_for_cc_bcc();"><?php _trans('lable1122'); ?></a>
                       			</div>
							</div>
							<div class="withfull option_for_cc_bcc" style="display: none;">
								
								<div class="form_group">
									<label class="form_label"><?php _trans('lable813'); ?></label>
									<div class="form_controls">
								...
								<div class="form_group">
									<label class="form_label"><?php _trans('lable814'); ?></label>
									<div class="form_controls">
							...
							<div class="form_group">
                                <label class="form_label"><?php _trans('lable811'); ?></label>
                                <div class="form_controls">
                                    <input type="text" name="subject" id="subject" class="form-control" value="<?php if($email_templates[0]->email_template_subject){ echo $email_templates[0]->email_template_subject; }else { echo 'Jobcard from  '.$this->session->userdata('user_company'); } ?>" autocomplete="off">
                                </div>
                            </div>
                            
							<div class="form_group">
									<label class="form_label"><?php echo _trans('lable810'); ?></label>
									<div class="form_controls">
