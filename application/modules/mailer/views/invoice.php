...
<form method="post" action="<?php echo site_url('mailer/send_invoice/' . $invoice->invoice_id) ?>" autocomplete="off" >
    <input type="hidden" name="_ip_csrf" value="<?= $this->security->get_csrf_hash() ?>"autocomplete="off">
            ...
            <div class="col-xs-12 col-md-8 col-md-offset-2">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="to_email" id="to_email" class="form-control" required
                           value="<?php echo $invoice->client_email; ?>" autocomplete="off">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="email_template" id="email_template" class="bootstrap-select bootstrap-select-arrow form-control removeError" data-live-search="true" autocomplete="off" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="from_name" id="from_name" class="form-control"
                           value="<?php _htmlsc($invoice->user_name); ?>" autocomplete="off">
                </div>

                <div class="form-group">
                    <label for="from_email"><?php _trans('from_email'); ?></label>
                    <input type="email" name="from_email" id="from_email" class="form-control"
                           value="<?php echo $invoice->user_email; ?>" autocomplete="off">
                </div>

                <div class="form-group">
                    <label for="cc"><?php _trans('cc'); ?></label>
                    <input type="text" name="cc" id="cc" value="" class="form-control" autocomplete="off">
                </div>

                <div class="form-group">
                    <label for="bcc"><?php _trans('bcc'); ?></label>
                    <input type="text" name="bcc" id="bcc" value="" class="form-control" autocomplete="off">
                </div>

                <div class="form-group">
                    <label for="subject"><?php _trans('subject'); ?></label>
                    <input type="text" name="subject" id="subject" class="form-control"
                           value="<?php echo trans('lable119') . ' #' . $invoice->invoice_number; ?>" autocomplete="off">
                </div>

                <div class="form-group">
                    <label for="pdf_template"><?php _trans('pdf_template'); ?></label>
                    <select name="pdf_template" id="pdf_template" class="bootstrap-select bootstrap-select-arrow form-control removeError" data-live-search="true" autocomplete="off">
                        <option value=""><?php _trans('none'); ?></option>
                ...
                <div class="form-group"><label for="invoice-guest-url"><?php _trans('guest_url'); ?></label>
                    <div class="input-group">
                        <input type="text" id="invoice-guest-url" readonly class="form-control"
                               value="<?php echo site_url('guest/view/invoice/' . $invoice->invoice_url_key) ?>"autocomplete="off">
