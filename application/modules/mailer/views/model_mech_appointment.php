...
<script type="text/javascript">
    ...
    $(function () {
	    ...
	    $('#btn_generate_pdf').click(function () {
			window.open('<?php echo site_url('mech_appointments/generate_pdf/' .($invoice_id)); ?>', '_blank');
        });
...
<div class="modal fade" id="send-invoice" tabindex="-1" role="dialog" aria-labelledby="addNewCustomerLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content" id="add_customer_fdetail">
				<form method="post" class="form-horizontal" action="<?php echo site_url('mailer/send_mech_invoice/' .($invoice_id).'/'.$cat); ?>">
				...
				<div class="modal-body">
					<div class="form">
						...
						<div class="row">
							...
							<div class="option_for_cc_bcc" style="display: none;">
