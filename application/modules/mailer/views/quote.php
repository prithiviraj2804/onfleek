            ...
            <div class="col-xs-12 col-md-8 col-md-offset-2">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="to_email" id="to_email" class="form-control" required
                           value="<?php echo $quote->client_email; ?>" autocomplete="off">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="email_template" id="email_template" class="bootstrap-select bootstrap-select-arrow form-control removeError" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="subject" id="subject" class="form-control"
                           value="<?php _trans('quote'); ?> #<?php echo $quote->quote_number; ?>" autocomplete="off">
                </div>

                <div class="form-group">
                    <label for="pdf_template"><?php _trans('pdf_template'); ?></label>
                    <select name="pdf_template" id="pdf_template" class="bootstrap-select bootstrap-select-arrow form-control removeError" autocomplete="off">
                        <option value=""><?php _trans('none'); ?></option>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="text" id="quote-guest-url" readonly class="form-control"
                               value="<?php echo site_url('guest/view/quote/' . $quote->quote_url_key); ?>"autocomplete="off">
