...
<div id="content" class="usermanagement uploadcss">
	<div class="row">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 top-15">
			<a class="anchor anchor-back" href="<?php echo site_url('clients'); ?>"><i class="fa fa-long-arrow-left"></i><span><?php _trans('lable59'); ?></span></a>
		</div>
  </div>
  <section class="card">
    <div class="card-block">
      <div class="row col-lg-12 col-md-12 col-sm-12 col-xs-12 paddingTop20px">
        <div class="col-lg-10 col-md-10 col-sm-9 col-xs-9 instruction_content"><?php _trans('lable609'); ?> <a class="download_sample" href="<?php echo site_url('clients/download_csv'); ?>"><?php _trans('lable608'); ?></a> <?php _trans('lable607'); ?></div>
      </div>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 padding20px upload_border">
                    <form class="col-lg-12 col-md-12 col-sm-12" id="upload_csv" method="post" enctype="multipart/form-data">  
                      <div class="padding0px col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <input type="file" id="chfile" onchange="getfile()" name="client_file" class="inputfile"/>
...
$(document).ready(function(){
    ...
    $('#upload_csv').on("submit", function(e){               
      ...
      $.ajax({  
           url:"<?php echo site_url('clients/importcsv'); ?>",
           method:"POST",  
           ...
           //console.log(response);
                ...
                {
                    $("#upload_loader").hide();
                    window.location = "<?php echo site_url('clients/upload'); ?>";
                }
