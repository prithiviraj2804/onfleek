<header class="page-content-header">
    <div class="container-fluid">
        <div class="tbl">
            <div class="tbl-row">
                <div class="tbl-cell">
                    <h3><?php _trans('lable636'); ?></h3>
                </div>
                <div class="tbl-cell pull-right">
                    <a class="btn btn-rounded btn-primary btn-padding-left-right-40" target="_blank" href="<?php echo site_url('reports/generate_pdf/SalesServiceReports/'.date_to_mysql($from_date).'/'.date_to_mysql($to_date).'/'.$user_branch_id); ?>">
                ...
                <table class="display table table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text_align_center"><?php _trans('lable852'); ?></th>
                    ...
                    <tbody>
                        ...
                        foreach ($results as $result){
                            ...
                            <tr>
                                ...
                                <td class="text_align_center"><strong><?php _trans('lable887'); ?> = <?php echo $totalServceCount; ?></strong></td>
                                <td class="text_align_right"><strong><?php _trans('lable638'); ?> =  <?php echo format_currency($overall_grand_total); ?></strong></td>
                            <tr>
                            <?php }else{ ?>
                        <tr>
