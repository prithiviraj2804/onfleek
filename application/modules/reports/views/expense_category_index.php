<header class="page-content-header">
    <div class="container-fluid">
        <div class="tbl">
            <div class="tbl-row">
                <div class="tbl-cell">
                    <h3><?php _trans('lable648'); ?></h3>
                </div>
                <div class="tbl-cell pull-right">
                    <a class="btn btn-rounded btn-primary btn-padding-left-right-40" target="_blank" href="<?php echo site_url('reports/generate_pdf/ExpenseCategoryReports/'.date_to_mysql($from_date).'/'.date_to_mysql($to_date).'/'.$user_branch_id); ?>">
        ...
        <div class="card-block">
            <div class="overflowScrollForTable">
                <table class="display table table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th class="text_align_left"><?php _trans('lable884'); ?></th>
                            <th class="text_align_center"><?php _trans('lable647'); ?></th>
                            <th class="text_align_center"><?php _trans('lable649'); ?></th>
                    ...
                    <tbody>
                        <?php if(count($results) > 0){
                            ...
                            <tr>
                                <td class="text_align_left"><?php echo ($result->expense_date?date_from_mysql($result->expense_date):" "); ?></td>
                                <td class="text_align_center"><?php echo $result->expense_category_name; ?></td>
                                <td class="text_align_center"><?php echo $result->expensehead; ?></td>                                
                                <td class="text_align_center"><?php echo $this->mdl_settings->currencychanger($this->session->userdata('default_currency_code')); ?>&nbsp;<?php echo format_money($result->grand_total,$this->session->userdata('default_currency_digit')); ?></td>
                            </tr>
                            <?php } ?>
                            <tr>
                                <td colspan="3"><strong><?php _trans('lable638'); ?></strong></td>
                                <td align="center"><strong><?php echo $this->mdl_settings->currencychanger($this->session->userdata('default_currency_code')); ?>&nbsp;<?php echo format_money($overall_grand_total,$this->session->userdata('default_currency_digit')); ?></strong></td>
