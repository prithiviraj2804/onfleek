        ...
        <div class="tbl">
            <div class="tbl-row">
                ...
                <div class="tbl-cell pull-right">
                    <a class="btn btn-rounded btn-primary btn-padding-left-right-40" target="_blank" href="<?php echo site_url('reports/generate_pdf/SalesSummaryReports/'.date_to_mysql($from_date).'/'.date_to_mysql($to_date).'/'.$user_branch_id); ?>">
                ...
                <table class="display table table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        foreach ($results as $result){
                            $overallInvoiceCount += $result->cnt;
                            $overall_grand_total += $result->total;  ?>
                        <tr>
                            <td class="text_align_center"><?php echo ($result->invoice_date?date_from_mysql($result->invoice_date):" "); ?></td>
                            <td class="text_align_center"><?php echo $result->cnt; ?></td>
                            <td class="text_align_right"><?php echo format_currency($result->total, 2); ?></td>
                        </tr>
                        <?php } ?>
                        <tr>
                            <td></td>
