<header class="page-content-header">
    <div class="container-fluid">
        <div class="tbl">
            <div class="tbl-row">
                <div class="tbl-cell">
                    <h3><?php _trans('lable620'); ?></h3>
                </div>
                <div class="tbl-cell pull-right">
                    <a class="btn btn-rounded btn-primary btn-padding-left-right-40" target="_blank" href="<?php echo site_url('reports/generate_inventory_lowstock_pdf/InventoryLowStock/'.($product_name?$product_name:0).'/'.($product_category?$product_category:0)); ?>">
                ...
                <table class="display table table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text_align_center"><?php _trans('lable222'); ?></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text_align_center"><?php echo ($result->reorder_quantity?$result->reorder_quantity:"-"); ?></td>
