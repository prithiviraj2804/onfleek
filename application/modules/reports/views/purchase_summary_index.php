<header class="page-content-header">
    <div class="container-fluid">
        <div class="tbl">
            <div class="tbl-row">
                <div class="tbl-cell">
                    <h3><?php _trans('lable1129'); ?></h3>
                </div>
                <div class="tbl-cell pull-right">
                    <a class="btn btn-rounded btn-primary btn-padding-left-right-40" target="_blank" href="<?php echo site_url('reports/generate_pdf/PurchaseSummaryReport/'.date_to_mysql($from_date).'/'.date_to_mysql($to_date).'/'.$user_branch_id); ?>">
                ...
                <table class="display table table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                     ...
                     foreach ($results as $result){ 
                         ...
                         ?>
                        <tr>
                            <td class="text_align_left"><a href="<?php echo site_url('mech_purchase/view/' . $result->purchase_no); ?>"><?php echo $result->purchase_no; ?></a></td>
