    ...
    <div id="content">
        <div class="row">
				<div class="col-xs-12 top-15">
					<a class="anchor anchor-back" onclick="goBack()" href="<?php echo site_url('suppliers_category/index'); ?>"><i class="fa fa-long-arrow-left"></i><span><?php _trans('lable59'); ?></span></a>
				</div>
            <div class="col-xs-12 col-md-12 col-md-offset-3">
				<div class="container-wide">
                	<input class="hidden" name="is_update" id="is_udpate" type="hidden" value=""<?php if($this->mdl_suppliers_category->form_value('is_update')){
    echo "1";
} else {
    echo "0";
}?>
					...
					<div class="col-sm-9">
						<input type="hidden" name="suppliers_category_id" id="suppliers_category_id" class="form-control" value="<?php echo $this->mdl_suppliers_category->form_value('suppliers_category_id', true); ?>"autocomplete="off">
					</div>
					<div class="box">
						<div class="box_body">
								<div class="form_group">
									<label class="form_label"><?php _trans('lable244'); ?>*</label>
									<div class="form_controls">
										<input type="text" name="suppliers_category_name" id="suppliers_category_name" class="form-control"
                           					value="<?php echo $this->mdl_suppliers_category->form_value('suppliers_category_name', true); ?>" autocomplete="off">
									</div>
								</div>
	...
	$("#btn_cancel").click(function () {
        window.location.href = "<?php echo site_url('suppliers_category'); ?>";
    });
    ...
    $(".btn_submit").click(function () {
		...
		$.post('<?php echo site_url('suppliers_category/ajax/create'); ?>', {
            ...
            if(list.success=='1'){
				...
				setTimeout(function(){
					window.location = "<?php echo site_url('suppliers_category'); ?>";
				}, 100);
