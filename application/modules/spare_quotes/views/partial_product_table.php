    ...
    <div class="col-lg-12">
        ...
        <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12" style="padding: 10px 15px;">
            ...
            <select id="parts_discountstate" name="parts_discountstate" onchange="part_discountstate()" class="col-lg-4 col-md-4 col-sm-4 col-xs-12 bootstrap-select bootstrap-select-arrow form-control">
                <option <?php if ($quotes_detail->parts_discountstate == 1) { echo 'selected'; } ?> value="1">&#8377;</option>
                <option <?php if ($quotes_detail->parts_discountstate == 2) { echo 'selected'; } ?> value="2">&#37;</option>
            </select>
        </div>
        <section class="box-typical" style="overflow-x: inherit;">
            ...
            <?php
                ...
                <a class="float_left fontSize_85rem addproduct" href="javascript:void(0)" data-entity-type="SQ" data-toggle="modal" data-existing_product_ids="<?php echo $existing_product_ids; ?>" data-entity-id="<?php echo $quotes_detail->quote_id;?>" data-customer-id="<?php echo $quotes_detail->customer_id;?>" data-model-from="quote" data-target="#addproduct">
                ...
                <table class="display table table-bordered" id="product_item_table" width="100%" style="width:100%;float:left;table-layout: fixed;">
                    <thead>
                        ...
                        <th width="7%;" style="width:7%;max-width:7%;" class="text-right">
                            <span class="showrupee" <?php if($quotes_detail->parts_discountstate != 2 ){ echo 'style="display:block"';}else{ echo 'style="display:none"';} ?> ><?php echo $this->mdl_settings->currencychanger($this->session->userdata('default_currency_code')); ?></span>
                            <span class="showpercentage" <?php if($quotes_detail->parts_discountstate == 2 ){ echo 'style="display:block"';}else{ echo 'style="display:none"';} ?>>%</span>&nbsp;
                    ...
                    <tbody>
                        ...
                        <tr class="item" id="tr_<?php echo $product->item_id; ?>">
                            ...
                            <td width="4%;" style="width:2%;max-width:2%;" class="text-center">
                                <span onclick="remove_item(<?php echo $product->item_id; ?>,'prod','spare_quotes','<?= $this->security->get_csrf_hash(); ?>');"><i class="fa fa-times"></i></span>
                            </td>
                        </tr>
                        <?php } } ?>
                    </tbody>
