...
<div class="container-fluid viewPages">
	<section class="card">
		<div class="card-block invoice">
			...
			<?php $this->layout->load_view('spare_quotes/partial_product_table_view'); ?>
			...
			<div class="row invoiceFloatbtn">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 clearfix buttons text-right">
					<a class="btn btn-rounded btn-primary btn-padding-left-right-40" href="<?php echo site_url('spare_quotes/create/'.$quote_detail->quote_id); ?>">
						<i class="fa fa-edit fa-margin"></i> <?php _trans('lable44'); ?>
					</a>
					<a class="btn btn-rounded btn-primary btn-padding-left-right-40" target="_blank" href="<?php echo site_url('spare_quotes/generate_pdf/'.$quote_detail->quote_id); ?>">
