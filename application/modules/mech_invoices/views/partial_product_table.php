                    ...
                    <tbody>
                        ...
                        <tr class="item" id="tr_<?php echo $product->item_id; ?>">
                            ...
                            <td width="4%;" style="width:2%;max-width:2%;" class="text-center">
                                <span onclick="remove_item(<?php echo $product->item_id; ?>,'prod','mech_invoices','<?= $this->security->get_csrf_hash(); ?>');"><i class="fa fa-times"></i></span>
                            </td>
                        </tr>
                        <?php } } ?>
                    </tbody>
