				...
				<table class="display table table-bordered" id="service_package_item_table" style="table-layout: fixed;" >
					...
					<?php 
						...
						<tr class="item" id="tr_<?php echo $service->item_id; ?>">
							...
							<td class="text-center" width="5%;" style="width:5%;max-width:5%;"><span onclick="remove_item(<?php echo $service->item_id; ?>,'package','mech_invoices','<?= $this->security->get_csrf_hash(); ?>');"><i class="fa fa-times"></i></span></td>
						</tr>
						<?php } } ?>
					</tbody>
