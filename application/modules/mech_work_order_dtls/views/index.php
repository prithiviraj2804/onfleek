	...
	<section class="card">
		<div class="card-block">
            <div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12 padding0px">
                ...
                <?php /*print_r($work_orders);*/ ?>
                <div class="form_group col-xl-4 col-lg-4 col-md-4 col-sm-4">
                    <label class="form_label"><?php _trans('lable19'); ?></label>
                    <div class="form_controls">
                        <select onchange="searchFilter()" name="jobsheet_status" id="jobsheet_status" class="searchSelect bootstrap-select bootstrap-select-arrow form-control customerList " data-live-search="true">
                    ...
                    <table class="display table datatable table-bordered" cellspacing="0" width="100%">
                        ...
                        <?php if(count($work_orders)>0) {
                            ...
                            <tr>
                                ...
                                <td data-original-title="<?php _htmlsc($work_ord_list->status_name); ?>" data-toggle="tooltip" class="textEllipsis"><?php _htmlsc($work_ord_list->status_name); ?></td>
...
function vehiclenumber(){
        ...
        if(vehicle_no.length > 2){
            $('#gif').show();
            $.post('<?php echo site_url('mech_work_order_dtls/ajax/getjobvehiclenos'); ?>', {
...
function searchFilter(page_num) {
    ...
    $.post('<?php echo site_url('mech_work_order_dtls/ajax/get_filter_list'); ?>', {
        ...
        if(list.success=='1'){
            ...
            html += '<thead><tr><th class="text-center"><?php _trans("lable278");?></th>';
            ...
            if(list.work_orders.length > 0){
                ...
                {    
                    ...
                    html += '<td data-original-title="'+((list.work_orders[v].status_name)?list.work_orders[v].status_name:" ")+'" data-toggle="tooltip" class="textEllipsis">'+((list.work_orders[v].status_name)?list.work_orders[v].status_name:" ")+'</td>';
                    ...
                    html += '<li>';
					html += '<a href="javascript:void(0)" data-type-id="J" data-toggle="modal" data-target="#sendSms" data-invoice-id="'+list.work_orders[v].work_order_id+'" class="send_sms">';
                    ...
                    html += '<li>';
                    html += '<a href="javascript:void(0)" onclick="remove_jobsheet(\''+list.work_orders[v].work_order_id+'\',\'<?= $this->security->get_csrf_hash() ?>\')">';
