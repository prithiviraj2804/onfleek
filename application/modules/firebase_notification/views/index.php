...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-center imageDynamicHeight" style="display: table;">
    <div class="tbl-cell">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-center">
            <a class="btn btn-sm btn-primary" href="<?php echo site_url('firebase_notification/form'); ?>">
                <i class="fa fa-plus"></i> <?php _trans('lable1214'); ?>
            </a>
        </div>
    </div>
</div>
...
<header class="page-content-header">
    <div class="container-fluid">
        <div class="tbl">
            <div class="tbl-row">
                <div class="tbl-cell">
                    <h3><?php _trans('lable1217'); ?></h3>
                </div>
                <div class="tbl-cell pull-right">
                    <a class="btn btn-sm btn-primary" href="<?php echo site_url('firebase_notification/form'); ?>">
                        <i class="fa fa-plus"></i> <?php _trans('lable1218'); ?>
                    </a>
                </div>
            </div>
        </div>
                ...
                <table class="display table datatable table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text_align_center" data-original-title="<?php echo $this->mdl_firebase_notification->get_email_status_count($bulkemail->id,'P'); ?>" data-toggle="tooltip" class="textEllipsis"><?php echo $this->mdl_firebase_notification->get_email_status_count($bulkemail->id,'P'); ?></td>
                            <td class="text_align_center" data-original-title="<?php echo $this->mdl_firebase_notification->get_email_status_count($bulkemail->id,'S'); ?>" data-toggle="tooltip" class="textEllipsis"><?php echo $this->mdl_firebase_notification->get_email_status_count($bulkemail->id,'S'); ?></td>
                            <td class="text_align_center" data-original-title="<?php echo $this->mdl_firebase_notification->get_email_status_count($bulkemail->id,'F'); ?>" data-toggle="tooltip" class="textEllipsis"><?php echo $this->mdl_firebase_notification->get_email_status_count($bulkemail->id,'F'); ?></td>
                            <td class="text_align_center" data-original-title="<?php echo $this->mdl_firebase_notification->get_email_status_count($bulkemail->id,'C'); ?>" data-toggle="tooltip" class="textEllipsis"><?php echo $this->mdl_firebase_notification->get_email_status_count($bulkemail->id,'C'); ?></td>
                        </tr>
...
function searchFilter(page_num) {
    ...
    $.post('<?php echo site_url('firebase_notification/ajax/get_filter_list'); ?>', {
        page : page_num,
        from_date : from_date,
        to_date   : to_date,
