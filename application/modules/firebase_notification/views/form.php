				...
				<div class="container">					
					<div class="box">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 box_body">
							<h3 class="text-center"><?php _trans('lable1215'); ?></h3>	
							...
							<button value="2" name="btn_submit" class="btn_submit btn btn-rounded btn-primary btn-padding-left-right-40">
								<i class="fa fa-check"></i> <?php _trans('lable1216'); ?>
							</button>
...
<script type="text/javascript">
	...
	$("#btn_cancel").click(function () {
        window.location.href = "<?php echo site_url('firebase_notification/form'); ?>";
	});
	...
	$(".add_btn").click(function () {
		...
		$.post('<?php echo site_url('firebase_notification/ajax/add'); ?>', {
    ...
    $(".btn_submit").click(function () {
		...
		if(client_list.length){
			...
			$.ajax({
				url: "<?php echo site_url('firebase_notification/ajax/create'); ?>",
                dataType: 'json',
                cache: false,
                contentType: false,
                processData: false,
				...
				success:function(data)
				{
					if(data.success == '1'){
						...
						setTimeout(function(){
							window.location = "<?php echo site_url('firebase_notification'); ?>";
						}, 100);
					}else{
						$('#gif').hide();
