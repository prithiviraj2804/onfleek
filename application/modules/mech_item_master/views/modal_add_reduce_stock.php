...
$(".removeError").change(function() {
    ...
    var purchase_price = "<?php echo $purchase_price; ?>";
    ...
    $('#save_stock').click(function () {
        ...
        $.post("<?php echo site_url('mech_item_master/ajax/save_stock'); ?>", {
        ...
        function (data) {
            ...
            if(response.success === 1){
                ...
                // if(page == "index"){
                //     window.location.href = '<?php echo site_url() . "/mech_item_master";?>';
                // }else{
                //     window.location.href = '<?php echo site_url() . "/mech_item_master/view_inventory/";?>'+product_id;
                // }
                setTimeout(function() {
                    location.reload();
                }, 1000);
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group" style="width: 100%">
                                        ...
                                        <input type="text" class="form-control check_error_label" name="price" id="price" placeholder="Enter price per quantity" value="<?php echo $purchase_price; ?>" autocomplete="off">
