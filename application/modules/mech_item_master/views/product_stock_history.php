        ...
        <div class="tbl">
            <div class="tbl-row">
                ...
                <div class="tbl-cell pull-right">
                    <a class="btn btn-sm btn-primary add_reduce_stock" data-page-from="history" href="javascript:void(0)" data-product-id="<?php echo $product->product_id; ?>" data-action-type="add_stock" data-purchase-price="<?php echo $product->cost_price; ?>">
                        <i class="fa fa-plus"></i> <?php _trans('lable214'); ?>
                    </a>
                    <a class="btn btn-sm btn-primary add_reduce_stock" data-page-from="history" href="javascrip:void(0)" data-product-id="<?php echo $product->product_id; ?>" data-action-type="reduce_stock" data-purchase-price="<?php echo $product->cost_price; ?>">
...
<div id="content" class="table-content">
    ...
    <section class="card">
		<div class="card-block">
            <h3><?php _htmlsc($product->product_name)?></h3>
            <span>(<?php _trans('lable651'); ?>: <?php _htmlsc($product->balance_stock)?> )</span>
                        ...
                        <?php /* * /?><td>
                            <div class="options btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="<?php echo site_url('mech_item_master/form/' . $product->product_id); ?>">
                                            <i class="fa fa-edit fa-margin"></i> <?php _trans('edit'); ?>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo site_url('mech_item_master/delete/' . $product->product_id); ?>"
