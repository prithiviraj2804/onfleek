...
<div class="row">
	<div class="col-xs-12 top-15">
		<a class="anchor anchor-back" href="<?php echo site_url('mech_pos_invoices/index'); ?>"><i class="fa fa-long-arrow-left"></i><span><?php _trans('lable59'); ?></span></a>
	</div>
</div>
<div class="container-fluid viewPages">
	<section class="card">
		<div class="card-block invoice">
							...
							<td width="54%" class="firstSectionSecondtd">
								...
								<?php if($invoice_detail->invoice_no){ ?>
										<tr width="100%" style="width:100%;">
											<td width="40%" class="text-right"><?php _trans('lable29'); ?> :</td>
											<td width="60%" class="text-right"><?php echo $invoice_detail->invoice_no; ?></td>
										</tr>
									<?php } if($invoice_detail->invoice_date){ ?>                    
										<tr width="100%" style="width:100%;">
											<td width="60%" class="text-right"><?php _trans('lable368'); ?> :</td>
			...
			<?php if($is_product == 'Y'){ $this->layout->load_view('mech_pos_invoices/partial_product_table_view'); } ?>
			<?php $this->layout->load_view('mech_pos_invoices/partial_service_table_view'); ?>
			<?php $this->layout->load_view('mech_pos_invoices/partial_service_package_table_view'); ?>
			...
			<div class="row invoiceFloatbtn">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 clearfix buttons text-right">
					<a class="btn btn-rounded btn-primary btn-padding-left-right-40" href="<?php echo site_url('mech_pos_invoices/create/'.$invoice_detail->invoice_id); ?>">
						<i class="fa fa-edit fa-margin"></i> <?php _trans('lable44'); ?>
					</a>
					<a class="btn btn-rounded btn-primary btn-padding-left-right-40" target="_blank" href="<?php echo site_url('mech_pos_invoices/generate_thermal_pdf/'.$invoice_detail->invoice_id); ?>">
						<i class="fa fa-edit fa-margin"></i> <?php _trans('lable420'); ?>
					</a>
					<a class="btn btn-rounded btn-primary btn-padding-left-right-40" target="_blank" href="<?php echo site_url('mech_pos_invoices/generate_pdf/'.$invoice_detail->invoice_id); ?>">
