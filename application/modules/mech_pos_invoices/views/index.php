...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-center imageDynamicHeight" style="display: table;">
    <div class="tbl-cell">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-center">
            <a class="btn btn-sm btn-primary" href="<?php echo site_url('mech_pos_invoices/create'); ?>">
                <i class="fa fa-plus"></i> <?php _trans('lable1025'); ?>
            </a>
        </div>
    </div>
</div>
...
<div class="container-fluid">
	<?php $this->layout->load_view('mech_pos_invoices/partial_admin_appointment_table'); ?>
</div>
<?php } ?>