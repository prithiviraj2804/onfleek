    ...
    $(function () {
        ...
        $('.select2').select2();
          ...
          $('#inv_btn_submit').click(function () {
            ...
            $.post("<?php echo site_url('spare_invoices/ajax/create'); ?>", {
                ...
                function (data) {
                    ...
                    if(response.success === 1){
						...
						setTimeout(function(){ window.location = "<?php echo site_url('spare_invoices/create'); ?>/"+response.invoice_id; }, 1000);
						...
						<div>
							<div class="row spacetop-20">
								<div class="col-sm-10 col-centered">
									<select class="select2 removeError" name="quote_id" id="quote_id" autocomplete="off">
