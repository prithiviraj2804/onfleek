<div class="paddingLeftRight0px table-details col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    <div class="col-lg-10 col-md-9 col-sm-8 col-xs-12" style="padding: 10px 15px;">
        <h3 class="margin0px"><?php _trans('lable344');?></h3>
    </div>
    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12" style="padding: 10px 15px;">
        ...
        <select id="parts_discountstate" name="parts_discountstate" onchange="part_discountstate()" class="col-lg-4 col-md-4 col-sm-4 col-xs-12 bootstrap-select bootstrap-select-arrow form-control">
            <option <?php if ($purchase_details->parts_discountstate == 1) { echo 'selected'; } ?> value="1">&#8377;</option>
            <option <?php if ($purchase_details->parts_discountstate == 2) { echo 'selected'; } ?> value="2">&#37;</option>
        </select>
    </div>
    <div class="col-lg-12">
        <section class="box-typical" style="overflow-x: inherit;">
            ...
            <?php if(count($product_ids) > 0){
                ...
                <a class="float_left fontSize_85rem addproduct" href="javascript:void(0)" data-entity-type="P" data-toggle="modal" data-existing_product_ids="<?php echo $existing_product_ids; ?>" data-entity-id="<?php echo $purchase_details->purchase_id;?>" data-customer-id="<?php echo $purchase_details->purchase_id;?>" data-model-from="purchase" data-target="#addproduct">
                ...
                <table class="display table table-bordered" id="product_item_table" width="100%" style="width:100%;float:left;table-layout: fixed;">
                    <thead>
                        ...
                        <th width="7%;" style="width:7%;max-width:7%;" class="text-right">
                            <span class="showrupee" <?php if($purchase_details->parts_discountstate != 2 ){ echo 'style="display:block"';}else{ echo 'style="display:none"';} ?> ><?php echo $this->mdl_settings->currencychanger($this->session->userdata('default_currency_code')); ?></span>
                            <span class="showpercentage" <?php if($purchase_details->parts_discountstate == 2 ){ echo 'style="display:block"';}else{ echo 'style="display:none"';} ?>>%</span>&nbsp;<?php _trans('lable349'); ?><br>(<?php _trans('lable350'); ?>)</th>
                    ...
                    <tbody>
                        ...
                        <tr class="item" id="tr_<?php echo $product->item_id; ?>">
                            ...
                            <td width="40%;" style="width:40%;max-width:40%;">
                                ...
                                <input type="hidden" name="duplicate_id" class="duplicate_id" id="duplicate_id_<?php echo $product->product_id; ?>" value="<?php echo $product->product_id;?>">
                            ...
                            <td width="8%;" style="width:8%;max-width:8%;">
                                <input type="text" name="item_hsn" class="item_hsn form-control" value="<?php echo $product->item_hsn; ?>">
                            </td>
                    ...
                    <tfoot class="product_total_calculations">
                        <td colspan="4" align="right"><span><b><?php _trans('lable339');?></b></span></td>
                        <td class="text-right">
