    ...
    <div class="tbl-cell">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-center">
            <a class="btn btn-sm btn-primary" href="<?php echo site_url('mech_purchase/create'); ?>">
                <i class="fa fa-plus"></i> <?php _trans('label934'); ?>
            </a>
        </div>
    </div>
</div>
...
<header class="page-content-header">
			<div class="container-fluid">
				<div class="tbl">
					<div class="tbl-row">
						<div class="tbl-cell">
							<h3><?php _trans('lable120'); ?> <small class="text-muted">( <?php echo count($purchase_list); ?> )</small></h3>
						</div>
						<div class="tbl-cell tbl-cell-action">
							<a href="<?php echo site_url('mech_purchase/create'); ?>" id="create_purchase" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> <?php _trans('lable40'); ?></a>
						</div>
					</div>
				</div>
			</div>
...
<div class="container-fluid">
	<?php 
        $this->layout->load_view('mech_purchase/partial_purchase_table');
    ?>
</div><!--.container-fluid-->
<?php } ?>