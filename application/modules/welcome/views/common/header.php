...
<head>
  ...
  <!-- Bootstrap Styles -->
  <link href="<?php echo base_url(); ?>assets/fv1/css/bootstrap.css" rel="stylesheet">
  
  <!-- Styles -->
  <link href="<?php echo base_url(); ?>assets/fv1/style.css" rel="stylesheet">
  
  <!-- Carousel Slider -->
  <link href="<?php echo base_url(); ?>assets/fv1/css/owl-carousel.css" rel="stylesheet">
  
  <!-- Flex Slider -->
  <link href="<?php echo base_url(); ?>assets/fv1/css/flexslider.css" rel="stylesheet">

  <!-- CSS Animations -->
  <link href="<?php echo base_url(); ?>assets/fv1/css/animate.min.css" rel="stylesheet">
  ...
  <link href="<?php echo base_url(); ?>assets/fv1/royalslider/royalslider.css" rel="stylesheet">
  <link href="<?php echo base_url(); ?>assets/fv1/royalslider/skins/default-inverted/rs-default-inverted.css" rel="stylesheet">
  
  <!-- SLIDER REVOLUTION 4.x CSS SETTINGS -->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/fv1/rs-plugin/css/settings.css" media="screen" />
